# A Corporate Social Responsibility (CSR) Web App 

An app that matches Corporate Social Responsibility (CSR) corporate volunteers (CV) and Person-In-Needs (PINs) together. Built with Next.js, Tailwind CSS, Flask, Supabase PostgreSQL, and BCE Architecture.
