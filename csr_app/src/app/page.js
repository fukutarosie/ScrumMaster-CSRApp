...
// Handle the change in the dropdown for the role
...
// login request to the API via the API Controller (Login Controller)
...
// returns dashboard route for successful logn
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-100 to-gray-200">
      <div className="max-w-md w-full space-y-6 p-10 bg-white rounded-xl shadow-lg">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-center text-3xl font-extrabold text-gray-900">CSR App</h2>
